<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #002B5B;">
  ...
  <div class="container">
    ...
    <a class="navbar-brand me-2  text-white" href="/">
      <i class="fa-solid fa-tree fa-lg" style="color: #efbd0b;"></i>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarButtonsExample">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link   fs-5 <?= urlIs('/notes') ? "text-success " : "text-white" ?>" href="/notes">Notes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link  fs-5 <?= urlIs('/todo') ? "text-success " : "text-white" ?>" href="/todo">TODO</a>
        </li>
      </ul>
      <!-- Left links -->
